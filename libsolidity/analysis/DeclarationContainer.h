...
public:
	...
	bool registerDeclaration(bool _allowOverwrite, Declaration const& _declaration, ASTString const* _name = nullptr, bool _invisible = false, bool _update = false);
	...
	Declaration const* conflictingDeclaration(bool _allowOverwrite, Declaration const& _declaration, ASTString const* _name = nullptr) const;
